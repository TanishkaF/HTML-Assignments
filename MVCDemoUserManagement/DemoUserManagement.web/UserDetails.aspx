                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="p-3">
                                <div>
                                    <span class="starSign" class="text-danger font-weight-bold">*</span>
                                    <asp:Label runat="server" AssociatedControlID="firstName" Text="First Name:" />
                                </div>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" class="basic-addon1">&#129489;</span>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="p-3">
                                ...
                                <div>
                                    <asp:Label runat="server" AssociatedControlID="middleName" Text="Gender:" />
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="p-3">
                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="fileUpload" Text="Upload Aadhar Card PDF:" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <asp:Label ID="aadharCardUploadLabel" runat="server" Text=""></asp:Label>
                                </div>
                            </div>
                        </div>
